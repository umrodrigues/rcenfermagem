...
const mockTitle = 'Consultoria no gerenciamento dos processos de enfermagem'

const mockText = `Os processos de enfermagem constituem uma parte importantíssima nos serviços de saúde, uma vez que são ferramentas que trazem segurança aos pacientes, instituições e aos profissionais. São muitas variáveis envolvidas no empreendedorismo na enfermagem, seja jurídica, gerencial ou de tecnologias, e todas importantes para conquistar uma boa posição no mercado. Contar com um especialista neste momento pode trazer segurança, fortalecimento e diminuição de custos, se tornando um processo mais assertivo.`
